@Fullsuite
Feature: End to End 014

  ########################################################
  # Automation ID - TC_E2E_014                           #
  ########################################################
  @EndToEnd @TC_E2E_014
  Scenario Outline: Verify user able to select product from Clearance header and apply filter and secure checkout the product
    ...
    When I select any values from "Clearance" "Clearance Clothing"

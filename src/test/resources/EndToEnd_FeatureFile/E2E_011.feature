@Fullsuite
Feature: End to End 011

  ########################################################
  # Automation ID - TC_E2E_011                           #
  ########################################################
  @EndToEnd @TC_E2E_011
  Scenario Outline: Verify user able to select product link from SHOP BY STYLE in the Ariat Footer and secure checkout the product

@Fullsuite
Feature: End to End 006

   ########################################################
  # Automation ID - TC_E2E_006                            #
  ########################################################

  @EndToEnd @TC_E2E_006
  Scenario Outline: Verify user able to select product from Ariat HomePage New Arrivals and secure checkout the product
    ...
    When I click "Ariat" link on Home page
    And  I verify New arrivals is display in the Ariat homepage

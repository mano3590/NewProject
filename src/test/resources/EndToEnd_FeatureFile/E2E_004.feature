@Fullsuite
Feature: End to End 004

  ########################################################
  # Automation ID - TC_E2E_004                           #
  ########################################################
  @EndToEnd @TC_E2E_004
  Scenario Outline: Verify user able to select product from Ariat HomePage widget links and secure checkout the product
